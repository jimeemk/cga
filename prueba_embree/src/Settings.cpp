...
void Settings::cargarConfiguraciones() {
	...
	Object* obj = new Object("Modelos/12221_Cat_v1_l3", rojo, Vec3fa(2,0,4), 0.2, Vec3fa(270, 0, 0));
	scene->addObject(obj);
	...
	//Atributos: material, centro, size, normal, right
	Object* plano = new Plano(verde, Vec3fa(0.f, -3.f, 0.f), 40, Vec3fa(0.f, 1.f, 0.f), Vec3fa(1.f, 0.f, 0.f));
