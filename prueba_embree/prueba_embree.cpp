...
std::vector<Vec3fa> colores_caras;
std::vector<Vec3fa> colores_vertices;
...
unsigned int agregarCubo(RTCDevice device, RTCScene escena) {
	...
	colores_vertices.push_back(Vec3fa(0, 0, 0)); vertices[0].x = -1; vertices[0].y = -1; vertices[0].z = -1;
	colores_vertices.push_back(Vec3fa(0, 0, 1)); vertices[1].x = -1; vertices[1].y = -1; vertices[1].z = +1;
	colores_vertices.push_back(Vec3fa(0, 1, 0)); vertices[2].x = -1; vertices[2].y = +1; vertices[2].z = -1;
	colores_vertices.push_back(Vec3fa(0, 1, 1)); vertices[3].x = -1; vertices[3].y = +1; vertices[3].z = +1;
	colores_vertices.push_back(Vec3fa(1, 0, 0)); vertices[4].x = +1; vertices[4].y = -1; vertices[4].z = -1;
	colores_vertices.push_back(Vec3fa(1, 0, 1)); vertices[5].x = +1; vertices[5].y = -1; vertices[5].z = +1;
	colores_vertices.push_back(Vec3fa(1, 1, 0)); vertices[6].x = +1; vertices[6].y = +1; vertices[6].z = -1;
	colores_vertices.push_back(Vec3fa(1, 1, 1)); vertices[7].x = +1; vertices[7].y = +1; vertices[7].z = +1;

	int tri = 0;
	Triangulo* triangulos = (Triangulo*)rtcSetNewGeometryBuffer(cubo, RTC_BUFFER_TYPE_INDEX, 0, RTC_FORMAT_UINT3, sizeof(Triangulo), 12);
	
	// left side
	colores_caras.push_back(Vec3fa(1, 0, 0)); triangulos[tri].v0 = 0; triangulos[tri].v1 = 1; triangulos[tri].v2 = 2; tri++;
	colores_caras.push_back(Vec3fa(1, 0, 0)); triangulos[tri].v0 = 1; triangulos[tri].v1 = 3; triangulos[tri].v2 = 2; tri++;

	// right side
	colores_caras.push_back(Vec3fa(0, 1, 0)); triangulos[tri].v0 = 4; triangulos[tri].v1 = 6; triangulos[tri].v2 = 5; tri++;
	colores_caras.push_back(Vec3fa(0, 1, 0)); triangulos[tri].v0 = 5; triangulos[tri].v1 = 6; triangulos[tri].v2 = 7; tri++;

	// bottom side
	colores_caras.push_back(Vec3fa(0.5f));  triangulos[tri].v0 = 0; triangulos[tri].v1 = 4; triangulos[tri].v2 = 1; tri++;
	colores_caras.push_back(Vec3fa(0.5f));  triangulos[tri].v0 = 1; triangulos[tri].v1 = 4; triangulos[tri].v2 = 5; tri++;

	// top side
	colores_caras.push_back(Vec3fa(1, 1, 0));  triangulos[tri].v0 = 2; triangulos[tri].v1 = 3; triangulos[tri].v2 = 6; tri++;
	colores_caras.push_back(Vec3fa(1, 1, 0));  triangulos[tri].v0 = 3; triangulos[tri].v1 = 7; triangulos[tri].v2 = 6; tri++;

	// front side
	colores_caras.push_back(Vec3fa(0, 0, 1)); triangulos[tri].v0 = 0; triangulos[tri].v1 = 2; triangulos[tri].v2 = 4; tri++;
	colores_caras.push_back(Vec3fa(0, 0, 1)); triangulos[tri].v0 = 2; triangulos[tri].v1 = 6; triangulos[tri].v2 = 4; tri++;

	// back side
	colores_caras.push_back(Vec3fa(1, 1, 0)); triangulos[tri].v0 = 1; triangulos[tri].v1 = 5; triangulos[tri].v2 = 3; tri++;
	colores_caras.push_back(Vec3fa(1, 1, 0)); triangulos[tri].v0 = 3; triangulos[tri].v1 = 5; triangulos[tri].v2 = 7; tri++;
	...
	const float time, const ISPCCamera& camara, RTCScene escena)
{
	...
	{
		Vec3fa diffuse = colores_caras.at(rh->hit.primID);
