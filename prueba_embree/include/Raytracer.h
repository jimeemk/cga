...
public:
	...
	float procesarOclusion(Vec3fa origen, Vec3fa direccion_luz, Vec3fa pos_luz, RTCScene escena, RTCIntersectContext context);
	...
	float getRadius(std::vector<Photon> photons, Vec3f pos);
	float softShadow(Vec3fa origen, RTCScene escena, RTCIntersectContext context);
